...
ผู้เล่นคนที่ 1 วาง mark x ช่อง R2_C1
    ...
    Wait Until Elemment Contains    id=R2_C1    X
ผู้เล่นคนที่ 2 วาง mark o ช่อง R3_C1
...
ผู้เล่นคนที่ 2 วาง mark o ช่อง R1_C3
    ...
    Wait Until Elemment Contains    id=R1_C3    O
ผู้เล่นคนที่ 1 วาง mark x ช่อง R2_C3   
    Click Element    id=R2_C3
    Wait Until Elemment Contains    id=R2_C3    X
เเสดงผล player1 เป็น 1 score 
